...
# ground-state configuration by electron number N (N=Z-q), aufbau; full
# periodic table, identical to tools/wfc_generator/gen_anion_rho_ld1.py so the
# polarizability and density references use the same atomic configurations.
_CONF = [
